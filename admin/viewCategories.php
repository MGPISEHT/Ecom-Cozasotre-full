        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                        <div class="d-flex justify-content-between ">
                            ...
                            <button class="btn btn-danger text-white" data-toggle="modal" data-target="#addCategoryModal">Add Categories</button>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <button class="dropdown-item text-info" data-toggle="modal" data-target="#editeCategoryModal<?php echo htmlspecialchars($row['id'] ?? ''); ?>" class="btn btn-primary">Edit <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
