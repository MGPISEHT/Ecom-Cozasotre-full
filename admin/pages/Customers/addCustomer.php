...
<body>
    <div class="modal fade" id="addModalCustomer" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form action="function.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="cusAddress" name="cusAddress" rows="3"></textarea>
                                        </div>

                                        <!-- Submit Button -->
                                        <button type="submit" name="add-customer" class="btn btn-primary">Add Customer</button>
